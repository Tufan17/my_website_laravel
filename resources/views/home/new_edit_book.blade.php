...
@section('content')
    ...
    <div class="col align-self-center" style="width: 85% ; height: 100% ; alignment: center;float: left">
        <h1 class="ml-5"> Kitap Ekle </h1>

        <form action="/new_book_add">

            <div class="mb-3">
                <label  class="form-label">Kitabın Adı</label>
                <input type="text" class="form-control" name="name" value="{{$book->name}}" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label  class="form-label">Kitabın Yazarı</label>
                <input type="text" class="form-control" name="writer" value="{{$book->writer}}" aria-describedby="emailHelp">
            </div>
